...
const BrowserFunctions = () => {
  ...
  const SelectWallet = () => {
    ...
    const { register, formState: { isSubmitting, isSubmitSuccessful }, handleSubmit } = useForm<swFormValues>({
      mode: 'onTouched',
      defaultValues: {
  ...
  const SaveBrpParams = () => {
    ...
    const { register, formState: { errors, isSubmitting, isSubmitSuccessful }, handleSubmit } = useForm<SbpFormValues>({ mode: 'onTouched' });
    ...
    return (
      <div style={{ ...formDivStyle }}>
        <form onSubmit={handleSubmit(onSubmit)} style={{
          ...
          <input style={{ ...inputStyle, ...(errors.oracleAddress && formInputErrorStyle) }}
            type='text'
            placeholder='addr...'
          ...
          <input style={{ ...inputStyle, ...(errors.betUntil && formInputErrorStyle) }}
            type='datetime-local'
          ...
          <input style={{ ...inputStyle, ...(errors.betReveal && formInputErrorStyle) }}
            type='datetime-local'
          ...
          <input style={{ ...inputStyle, ...(errors.betStep && formInputErrorStyle) }}
            type='number'
  ...
  const AddRefScript = () => {
    ...
    const { register, formState: { errors, isSubmitting }, handleSubmit } = useForm<arsFormValues>({ mode: 'onTouched' });
    ...
    return (
      ...
      <div style={{ ...formDivStyle }}>
        <form onSubmit={handleSubmit(onSubmit)} style={{
          ...
          <input style={{ ...inputStyle, ...(errors.putAddress && formInputErrorStyle) }}
            type='text'
            placeholder='addr...'
            { ...register("putAddress", simpleRequired)}
          />
          {errors.putAddress && <p style={{ ...formPErrorStyle }}>{errors.putAddress.message}</p>}
          <input style={{ ...buttonStyle, ...(isSubmitting && formButtonSubmittingStyle) }} type="submit" value={isSubmitting ? "Submitting" : "Submit"} />
  ...
  const PlaceBet = () => {
    ...
    const { register, formState: { errors, isSubmitting }, handleSubmit } = useForm<pbFormValues>({ mode: 'onTouched' });
    ...
    return (
      <div style={{ ...formDivStyle }}>
        <form onSubmit={handleSubmit(onSubmit)} style={{
          ...
          <input style={{ ...inputStyle, ...(errors.betGuess && formInputErrorStyle) }} type='number' {...register("betGuess", simpleIntRequired)}
            placeholder={nonNegativeIntegerString}
          />
          ...
          <input style={{ ...inputStyle, ...(errors.betAmt && formInputErrorStyle) }} type='number' {...register("betAmt", simpleIntRequired)}
            placeholder={nonNegativeIntegerString}
          />
          ...
          <input style={{ ...inputStyle, ...(errors.refScript && formInputErrorStyle) }}
            type='text'
          ...
          <input style={{ ...inputStyle, ...(errors.prevBetRef && formInputErrorStyle) }}
            type='text'
            placeholder='transaction-id#transaction-index'
            { ...register("prevBetRef")}
          />
  ...
  const AddRefInput = () => {
    ...
    const { register, formState: { errors, isSubmitting }, handleSubmit } = useForm<ariFormValues>({ mode: 'onTouched' });
    ...
    return (
      <div style={{ ...formDivStyle }}>
        <form onSubmit={handleSubmit(onSubmit)} style={{
          ...
          <input style={{ ...inputStyle, ...(errors.betAnswer && formInputErrorStyle) }} type='number' {...register("betAnswer", simpleIntRequired)}
            placeholder={nonNegativeIntegerString}
          />
  ...
  const TakeBets = () => {
    ...
    const { register, formState: { errors, isSubmitting }, handleSubmit } = useForm<tbFormValues>({ mode: 'onTouched' });
    ...
    return (
      <div style={{ ...formDivStyle }}>
        <form onSubmit={handleSubmit(onSubmit)} style={{
          ...
          <input style={{ ...inputStyle, ...(errors.oracleRefInputRef && formInputErrorStyle) }}
            type='text'
            placeholder='transaction-id#transaction-index'
