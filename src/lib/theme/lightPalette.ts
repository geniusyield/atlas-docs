export const lightPalette = {
  ...
  accent: {
    ...
    linearGreyShadowMediumScreens:
      "0px 255.462px 71.6197px #0000001a, 0px 163.541px 65.4164px #0000000f, 0px 91.9213px 55.2656px #00000036, 0px 40.6033px 40.6033px #0000005c, 0px 10.1508px 22.5574px #0000006b, 0px 0px 0px #0000006b", // browser tab shadow
    offWhiteBlue: "#9FB5FF", // browser tab second button
    blue: "#0038FF", // browser tab third button
    blueGreyLinearGradient: "linear-gradient(180deg, #ffffffcc 0%, #00000000 95.31%), #ffffff03", // Always up to date bg
    ...
    offWhite3: "#E4EAFF",
    blueRadialGradient: "linear-gradient(#073BF4 31%, #0D41F6 0%)", // subtitle
