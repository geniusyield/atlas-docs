...
What we have obtained is of [`Validator`](https://playground.plutus.iohkdev.io/doc/haddock/plutus-ledger-api/html/Plutus-V1-Ledger-Scripts.html#t:Validator) type defined in `plutus-ledger-api`, which is nothing but a wrapper around `Script` type defined in same.
